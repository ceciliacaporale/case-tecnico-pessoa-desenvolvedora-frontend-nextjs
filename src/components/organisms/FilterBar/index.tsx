...
export default function FilterBar({
  ...
  const visibleCategories = AVAILABLE_CATEGORIES.slice(0, 3);
  const hiddenCategories = AVAILABLE_CATEGORIES.slice(3);
  ...
  return (
    <nav className="flex flex-col md:flex-row justify-between items-start w-full px-0 py-4 gap-6">
                        ...
                        <li key={category.slug}>
                          <button
                            ...
                            className={`
                              ...
                              ${isActive ? "font-bold text-primary" : "text-primary hover:text-white hover:bg-primary"}
                            `}
                          >
                            {category.name}
                          </button>
